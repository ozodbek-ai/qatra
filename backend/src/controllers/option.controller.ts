...
export const createOptionController =
asyncHandler(async (req, res) => {

  const data =
    createOptionSchema.parse(req.body);

  const option =
    await optionService.createOption(data);
...
export const getOptionController =
asyncHandler(async (req, res) => {
...
export const getOptionsByQuestionController =
asyncHandler(async (req, res) => {
...
export const updateOptionController =
asyncHandler(async (req, res) => {

  const data =
    updateOptionSchema.parse(req.body);
...
export const deleteOptionController =
asyncHandler(async (req, res) => {
