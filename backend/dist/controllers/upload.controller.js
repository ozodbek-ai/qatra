...
import { uploadVideo, uploadAvatar, } from "../services/upload.service.js";
import { AppError } from "../utils/AppError.js";
import { prisma } from "../lib/prisma.js";
export const uploadVideoController = asyncHandler(async (req, res) => {
    if (!req.file) {
        throw new AppError("Video fayl topilmadi.", 400);
    }
...
export const updateMyAvatarController = asyncHandler(async (req, res) => {
    if (!req.file) {
        throw new AppError("Avatar rasmi topilmadi.", 400);
    }
